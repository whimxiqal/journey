...
with open(os.path.join(MESSAGES_PROPERTIES_FOLDER, MESSAGES_PROPERTIES_FILE_NAME), 'r') as messages_file:
...
for file_name in os.listdir(MESSAGES_PROPERTIES_FOLDER):
    ...
    with open(full_path, 'r') as messages_file:
        lines = messages_file.readlines()
    ...
    with open(full_path, 'w') as messages_file:
...
with open(MESSAGES_JAVA_FILE_PATH, 'w') as messages_java_file:
