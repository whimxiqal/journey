...
public class SearchApiImpl implements SearchApi {
  ...
  @Override
  public Future<SearchResult> runDestinationSearch(JourneyAgent agent, Cell origin, Cell destination, SearchFlags flags) {
    return runDestinationSearch(agent, origin, destination, flags.get());
  }

  @Override
  public Future<SearchResult> runPlayerDestinationSearch(UUID playerUuid, Cell destination, SearchFlags searchFlags) {
    return runPlayerDestinationSearch(playerUuid, destination, false, searchFlags.get());
  }
