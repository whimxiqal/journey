...
//    OldSearch<Point3D, Domain> bfs = new OldSearch<>(trailCache);
...
//      printer1[origin.getxCoord()][origin.getCoordinateY()] = 'A';
//    } else {
//      printer2[origin.getxCoord()][origin.getCoordinateY()] = 'A';
//    }
//    if (origin.getDomain().equals(domain1)) {
//      printer1[destination.getxCoord()][destination.getCoordinateY()] = 'B';
//    } else {
//      printer2[destination.getxCoord()][destination.getCoordinateY()] = 'B';
//    }
//
//    // Put in links
//    for (int i = 0; i < links.size(); i++) {
//      if (links.get(i).getOrigin().getDomain().equals(domain1)) {
//        printer1[links.get(i).getOrigin().getxCoord()][links.get(i).getOrigin().getCoordinateY()] = Character.forDigit(i, 10);
//      }
//      if (links.get(i).getOrigin().getDomain().equals(domain2)) {
//        printer2[links.get(i).getOrigin().getxCoord()][links.get(i).getOrigin().getCoordinateY()] = Character.forDigit(i, 10);
//      }
//      if (links.get(i).getDestination().getDomain().equals(domain1)) {
//        printer1[links.get(i).getDestination().getxCoord()][links.get(i).getDestination().getCoordinateY()] = Character.forDigit(i, 10);
//      }
//      if (links.get(i).getDestination().getDomain().equals(domain2)) {
//        printer2[links.get(i).getDestination().getxCoord()][links.get(i).getDestination().getCoordinateY()] = Character.forDigit(i, 10);
//      }
//    }
//  }
//
...
//      return this.getxCoord() * other.getxCoord() + this.getCoordinateY() * other.getCoordinateY() + this.coordinateZ * other.coordinateZ;
//    }
//
//    public String print() {
//      return String.format("(%d, %d, %d, %s)", coordinateX, coordinateY, coordinateZ, domain.getName());
//    }
//
//    @Override
...
//
//    @Override
//    public Completable<Point3D, Domain> getCompletion() {
...
//        for (int j = -1; j <= 1; j++) {
//          if (i == 0 && j == 0) continue;
//          if (origin.getxCoord() + i < 0) continue;
//          if (origin.getxCoord() + i >= boardSize) continue;
//          if (origin.getCoordinateY() + j < 0) continue;
//          if (origin.getCoordinateY() + j >= boardSize) continue;
//          Point3D adding = null;
//          if (origin.getDomain().equals(domain1)) {
//            // Make sure we can't go diagonal.getY() if adjacent borders won't allow such a move
//            if (i * i * j * j == 1 && board1[origin.getxCoord() + i][origin.getCoordinateY()] == null && board1[origin.getxCoord()][origin.getCoordinateY() + j] == null)
//              continue;
//            adding = board1[origin.getxCoord() + i][origin.getCoordinateY() + j];
//          }
//          if (origin.getDomain().equals(domain2)) {
//            // Make sure we can't go diagonal.getY() if adjacent borders won't allow such a move
//            if (i * i * j * j == 1 && board2[origin.getxCoord() + i][origin.getCoordinateY()] == null && board2[origin.getxCoord()][origin.getCoordinateY() + j] == null)
//              continue;
//            adding = board2[origin.getxCoord() + i][origin.getCoordinateY() + j];
//          }
//          if (adding != null) {
...
//        printer1[cell.getxCoord()][cell.getCoordinateY()] = '+';
//      }
//      if (cell.getDomain().equals(domain2)) {
//        printer2[cell.getxCoord()][cell.getCoordinateY()] = '+';
//      }
//      // Print boards
//      System.out.println("Board 1:");
//      printPrinter(printer1, boardSize);
