...
public class NavCustomCommand extends FunctionlessCommandNode {
  ...
  private static BufferedFunction<Player, List<String>> bufferedCustomLocationsFunction() {
    return new BufferedFunction<>(player -> {
      try {
        return IndicatorSpigot.getInstance().getDataManager()
  ...
  public static class NavCustomToCommand extends PlayerCommandNode {
    ...
    public boolean onWrappedPlayerCommand(@NotNull Player player,
      ...
      CustomEndpointManager<LocationCell, World> customEndpointManager = IndicatorSpigot.getInstance()
          .getDataManager()
          .getCustomEndpointManager();
      try {
        if (args.length >= 4) {
  ...
  public static class NavCustomDeleteCommand extends PlayerCommandNode {
    ...
    public boolean onWrappedPlayerCommand(@NotNull Player player,
      ...
      CustomEndpointManager<LocationCell, World> endpointManager = IndicatorSpigot.getInstance()
          .getDataManager()
          .getCustomEndpointManager();
  ...
  public static class NavCustomListCommand extends PlayerCommandNode {
    ...
    public boolean onWrappedPlayerCommand(@NotNull Player player,
      ...
      Map<String, LocationCell> cells = IndicatorSpigot.getInstance()
          .getDataManager()
          .getCustomEndpointManager()
