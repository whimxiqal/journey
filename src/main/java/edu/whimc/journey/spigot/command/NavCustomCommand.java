...
public class NavCustomCommand extends FunctionlessCommandNode {
  ...
  public static class NavCustomToCommand extends PlayerCommandNode {
    ...
    public boolean onWrappedPlayerCommand(@NotNull Player player,
      ...
      CustomEndpointManager<LocationCell, World> customEndpointManager = JourneySpigot.getInstance()
          .getDataManager()
          .getCustomEndpointManager();
      try {
        if (args.length >= 4) {
  ...
  public static class NavCustomDeleteCommand extends PlayerCommandNode {
    ...
    public boolean onWrappedPlayerCommand(@NotNull Player player,
      ...
      CustomEndpointManager<LocationCell, World> endpointManager = JourneySpigot.getInstance()
          .getDataManager()
          .getCustomEndpointManager();
      if (endpointManager.hasCustomEndpoint(player.getUniqueId(), args[0])) {
        JourneySpigot.getInstance().getDataManager().getCustomEndpointManager().removeCustomEndpoint(player.getUniqueId(), args[0]);
  ...
  public static class NavCustomListCommand extends PlayerCommandNode {
  ...
  public static class NavCustomSaveCommand extends PlayerCommandNode {
