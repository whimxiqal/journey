...
@Plugin("journey")
public class JourneySpongeApi10 extends JourneySponge {

  @Inject
  JourneySpongeApi10(Logger logger, PluginContainer pluginContainer, @ConfigDir(sharedRoot = false) Path configDir, Metrics.Factory metricsFactory) {
